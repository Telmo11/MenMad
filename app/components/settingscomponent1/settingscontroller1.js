(function(){
	...
	var settingsbioComponent = {
		templateUrl : '/app/components/settingscomponent1/settings1.html',
		controller : editCtrl1
	};

	angular
		.module('mentory')
		.component('settingsbioComponent',settingsbioComponent);
	
	//Controller for <settings-component>
	function editCtrl1(Person,Category,$window,$location,tagsService,Upload,$timeout,$route,alertify){
		var edit=this;
		edit.categoriesTags= [];
